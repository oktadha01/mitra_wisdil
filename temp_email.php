                                                                                ...
                                                                                <tr style="border-collapse:collapse">
                                                                                    <td align="left" style="padding:0;Margin:0;font-size:0px">
                                                                                        <a href="https://" style="font-family:arial,'helvetica neue',helvetica,sans-serif;font-size:14px;text-decoration:underline;color:#1376c8" target="_blank">
                                                                                            <img src="assets/images/DD.png" alt="" style="display:block;border:0;outline:none;text-decoration:none" width="90" class="CToWUd" data-bit="iit">
                                                                                        </a>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                ...
                                                                <tr>
                                                                    <td>
                                                                        <div align="left" style="Margin:0;font-size:14px;line-height:18px">
                                                                            <div>
                                                                                Halo [Nama Agncy],<br>Terima kasih atas pengajuan event Anda. Data yang Anda kirimkan telah berhasil kami terima dan akan segera kami proses. <br>Berikut detail pengajuan event Anda:
                                                                            </div>
                                                                            <div>
                                                                                <hr>
                                                                                ...
                                                                                <ul style="padding-left: 10px;">
                                                                                    ...
                                                                                    <li style="display: flex;gap: 33px;margin-bottom: 6px;">
                                                                                        ...
                                                                                        <span>: Perum Sambiroto Baru Block T-7 Kel.Sambiroto, Kec.Tembalang, Kota Semarang Jawa Tengah</span>
                                                                                    </li>
                                                                                </ul>
                                                                                <hr>
                                                                                <span>Data Agency:</span>
