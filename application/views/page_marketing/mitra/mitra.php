...
<div class="container p-0">
    <div class="box-form mb-3">
        <h5 class="font-weight-bold ml-3 mb-3"><i class="bi bi-person-vcard text-form-agency"> Form Input Mitra</i> </h5>
        <div class="row ">
            <div class="col-lg-3 col-md-3 col-12 mb-3">
                <div class="input-group">
                    <input type="text" id="nama" class="col" required>
            ...
            <div class="col-lg-3 col-md-3 col-6 mb-3">
                <div class="input-group">
                    <input type="text" id="no-wa" class="col" required>
                    <label class="label-in">Kontak</label>
                </div>
            </div>
            <div class="col-lg-3 col-md-3 col-12 mb-3">
                <div class="input-wrapper">
                    <label class="label-select2">Domisili</label>
                    <select class="select2 w-100" style="height:55px;" id="domisili-sales"
            ...
            <div class="col-lg-3 col-md-3 col-12">
                <div class="input-group">
                    <input type="text" id="alamat-sales" class="col" required>
                    <label class="label-in">Alamat</label>
                </div>
            </div>
        </div>
        <hr>
        <h5 class="font-weight-bold ml-3 mb-3"><i class="bi bi-calendar2-event text-form-event"> Form Input Payment</i></h5>
        <div class="row">
        ...
        <div class="row">
            ...
            <div class="col-6 pr-4">
                <button class="btn col btn-success simpan">Simpan <i class="bi bi-cloud-arrow-up"></i></button>
            </div>
        </div>
    </div>
    <div class="row">
            ...
            <div class="modal-footer d-inline">
                <div class="row">
                    <div class="col-8 p-0">
                        ...
                        <button type="button" class="btn btn-danger delete-event" data-dismiss="modal">Delete Data</button>
                    </div>
                    <div class="col-4 p-0">
